...
namespace Rookey.Frame.Model.Bpm
{
    ...
    /// 流程代理
    /// </summary>
    [ModuleConfig(Name = "流程代理", PrimaryKeyFields = "Bpm_WorkFlowId,Bpm_WorkNodeId,OrgM_EmpId", Sort = 82, StandardJsFolder = "Bpm")]
    public class Bpm_FlowProxy : BaseBpmEntity
    {
        ...
        /// 代理人
        /// </summary>
        [FieldConfig(Display = "代理人", ControlType = (int)ControlTypeEnum.DialogTree, IsRequired = true, RowNum = 2, ColNum = 2, HeadWidth = 80, HeadSort = 4, ForeignModuleName = "员工管理")]
        ...
        /// 是否启用
        /// </summary>
        [FieldConfig(Display = "是否启用", ControlType = (int)ControlTypeEnum.SingleCheckBox, DefaultValue = "1", RowNum = 3, ColNum = 1, HeadSort = 5)]
